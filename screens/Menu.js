    ...
    this.state = {
      ...
      allPopularFood: [
        ...
        },
        {
          ...
          description:
            "Stir fried thin sliced marinated pork in spicy sauce. Spicy",
          price: 9.13,
          quantity: 0
        }
      ],
  ...
  updateQuantity = (id, val) => {
    ...
    if (this.state.addedItems.length > 0) {
      ...
      if (objIndex > -1) {
        items[objIndex] = {
          ...items[objIndex],
          quantity: items[objIndex].quantity + val
        };
      ...
      <View>
        ...
        <View>
          {this.state.allPopularFood.map((food, index) => {
            return (
              <MenuItem onPress={this.addToCart} key={food.id} {...food} />
            );
          })}
        </View>
      </View>
